...
export default function Login({ onLogin }) {
  ...
  const [mode, setMode] = useState(isApp ? 'login' : 'admin'); // 'login', 'signup', 'admin'
              ...
              mode === 'login' ? (
                <>
                  ...
                  <Link 
                    ...
                    sx={{ color: '#0B2E59', fontWeight: 900, textDecoration: 'none', borderBottom: '1px solid rgba(11,46,89,0.2)', pb: 0.2 }}
                  >
                    Create Identity
                  </Link>
                </>
